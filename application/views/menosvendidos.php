    ...
    <body>
        ...
        <script>
            $(function () {
                ...
                $('#thtabla').append('<tr><th style="text-align:center" colspan="' + column.length + '">Productos menos vendidos</th></tr>' + dibujarColumn);
                /*EGRESO*/
                ...
                $('#thtabla_egreso').append('<tr><th style="text-align:center" colspan="' + column2.length + '">Productos menos comprados</th></tr>' + dibujarColumn2);
                moment.locale('es');
                var tabla = {
                    arr: [],
                    arr2: [],
