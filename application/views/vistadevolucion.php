    ...
    <body>
                ...
                <div class="col-md-12 col-lg-6 col-xl-6">
                    <section class="panel panel-default">
                        <header style="border-radius: 0px" class="panel-heading">
                            <h2 class="panel-title">Datos de la devolución</h2>
                        </header>
        ...
        <script>
            $(function () {
                ...
                $('#title-listar').html('<img src="' + imgU + '" alt="icon" class="img-circle" width="70"><?= $title ?>');
                moment.locale('es');
                $('#fecha-foot').html(' <i>' + moment().format('dddd DD [de] MMMM [de] YYYY [-] HH:mm' + '</i>'));
                var url = '<?= base_url() ?>devolver/listardetalle?id=<?= $_GET['id'] ?>';
                        var urlelim = '<?= base_url() ?>devolver/eliminardetalle';
                        var validarcedula = '<?= base_url() ?>devolver/validar';
                        var urlForm = '<?= base_url() ?>devolver/crear';
                        var dataTable;
                        var id_text = '<?= $id ?>';
                        dataTable = $.tablaAjax({
                            fixedHeader: false,
                            ...
                            id: id_text,
                            thead: ['Nª Factura', 'Producto', 'Fecha', 'Cantidad', 'Costo Unitario', 'Total'],
                            ajax: {
                                url: url,
                                urlelim: urlelim,
                                data: {"action": "Jsons"},
