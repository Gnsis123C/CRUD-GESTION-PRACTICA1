                                            ...
                                            <div class="">
                                                <form id="demo-form2"  autocomplete="off">
                                                    <div class="form-group row">
                                                        <div class="col-md-3">
                                                            <label for="id-date-range-picker-1">Ingresar año</label>
                                                        ...
                                                        <div class="col-md-3">
                                                            <label for="id-date-range-picker-1">Ingresar mes</label>
                                                        ...
                                                        <div class="col-md-4">
                                                            <label for="id-date-range-picker-1">Escoger producto</label>
                                                            <select class="form-control" id="idproducto">
                                                                <option value="0" >Seleccionar Producto</option>
                                                                <?php for ($x=0;$x<count($idproducto);$x++){ ?>
                                                                    <option  <?= ((isset($_GET['idproducto'])?$_GET['idproducto']:'0')==($idproducto[$x]->idproducto)?'selected':'') ?> value="<?= $idproducto[$x]->idproducto ?>" ><?= $idproducto[$x]->nombre ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
                                                    </div>
        ...
        <script>
            $(function(){
                $('#anio').change(function(){
                    ...
                    var idproducto = <?= (isset($_GET['idproducto'])?$_GET['idproducto']:0) ?>;
                    window.location = '<?= base_url() ?>'+'reporte/comparativocomprapormes?anio='+anio+'&mes='+mes+'&idproducto='+idproducto
                });
                $('#mes').change(function(){
                    var mes = $(this).val();
