                ...
                <div>
                    <div class="row">
                            ...
                            <section class="panel panel-default">
                                ...
                                <div style="border-radius: 0px" class="panel-body">
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12 col-lg-6 col-xl-6">
                                                <input value="<?= $idproveedor->idclienteproveedor ?>" id="idcliente" type="hidden">
                                                <table class="table table-bordered table-condensed">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td><b>Nombre: </b></td>
                                                            <td><?= $idproveedor->nombre ?> <?= $idproveedor->apellido ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td><b>RUC: </b></td>
                                                            <td><?= $idproveedor->cedularuc ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                        ...
                        <div class="col-md-12 col-lg-6 col-xl-6">
                            <section class="panel panel-default">
                                <header style="border-radius: 0px" class="panel-heading">
                                    <h2 class="panel-title">Motivo <?= $title ?></h2>
                                </header>
                                <div style="border-radius: 0px" class="panel-body">
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12 col-lg-12 col-xl-2">
                                                <label class="control-label">Ingresar Motivo</label>
                                                <textarea  id="devolucion" rows=3 cols=20 maxlength="100" class="form-control" placeholder="Motivo"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-lg-3 col-xl-3 form-group">
                                                ...
                                                <select id="idinventario" data-plugin-selectTwo class="form-control">
                                                    ...
                                                    <?php for ($i = 0; $i < count($idproducto); $i++) { ?>
                                                        <option valor="<?= $idproducto[$i]['precio'] ?>" idproducto="<?= $idproducto[$i]['idproducto'] ?>" cantidad="<?= $idproducto[$i]['cantidad'] ?>" restante="<?= $idproducto[$i]['cantidad'] ?>" value="<?= $idproducto[$i]['idproducto'] ?>"><?= $idproducto[$i]['producto'] ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                            <input placeholder="Ingresar Fecha" type="hidden" id="fechaexpi" value="<?= $fecha ?>">
                                            <div class="col-md-12 col-lg-3 col-xl-3 form-group">
                                                <label class="control-label">Cantidad</label>
                                                <input type="text" class="form-control" id="cantidad">
                                            </div>
                                            <div class="col-md-12 col-lg-4 col-xl-4 form-group">
                                                <label class="control-label">Precio</label>
                                                <input type="text" class="form-control" id="valor">
                                            </div>
                                            <div class="col-md-12 col-lg-2 col-xl-2 form-group">
                                    ...
                                    <div class="">
                                        ...
                                        <table class="table table-bordered mb-none">
                                            ...
                                            <tbody id="tbody_detalle">
                                                <tr>
                                                    <td colspan="7" align="center">No hay datos a mostrar</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                ...
                var tabla = {
                    ...
                    listardetalle: function () {
                        ...
                        for (var i in this.listDetalle) {
                            ...
                            //html += '<td align="center">' + ins.fechaexpi + '</td>';
                    ...
                    guardar: function () {
                        return $.ajax({
                            url: '<?= base_url() ?>devolver/crear?id=<?= $_GET['id'] ?>',
                                                type: 'POST',
                                    ...
                                    $('#guardarpla').click(function () {
                                        //if (tabla.listDetalle.length > 0) {
                                        var fecha = $('#fecha').val();
                                        var motivo = $('#devolucion').val();
                                        if (fecha != '' && motivo != '') {
                                            if (tabla.id() > 1) {
                                                planificacion.fecha = fecha;
                                                planificacion.motivo = motivo;
                                                ...
                                                tabla.guardar().done(function (data) {
                                                    ...
                                                    window.location = '<?= base_url() ?>compra/vista'
                                                    return;
                                                }).fail(function () {
                                            ...
                                            alert('Error!!' + 'Falta fecha o falta el motivo');
                                        }
                                    })
                                }
                                )
