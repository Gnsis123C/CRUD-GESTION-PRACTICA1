    ...
    <body>
        ...
        <script>
            $(function () {
                ...
                //FECHA NACIMIENTO
                var imgU = '<?= base_url() ?>static/img/user.png';
                ...
                var url = '<?= base_url() ?>cliente/listar';
                var urlelim = '<?= base_url() ?>cliente/eliminar';
                var validarcedula = '<?= base_url() ?>cliente/validar';
                var urlForm = '<?= base_url() ?>cliente/crear';
                var dataTable;
                var id_text = '<?= $id ?>';
                dataTable = $.tablaAjax({
                    fixedHeader: false,
                    ...
                    id: id_text,
                    thead: ['Nombres', 'Apellidos', 'Cédula', 'Estado'],
                    ajax: {
                        url: url,
                        urlelim: urlelim,
                        data: {"action": "Jsons"},
