...
class Producto extends CI_Controller {
    ...
    function __construct() {
        ...
        $this->Data->tabla = 'producto';
        $this->Data->id = 'idproducto';
    }
    ...
    public function index() {
        $data = array(
            ...
            'img' => base_url() . 'static/img/producto1.png',
            'list_title' => 'producto',
            'nameform' => 'producto',
            'idtipoproducto' => $this->Data->listarTabla('tipoproducto'),
            'titleform' => 'Administración de Producto',
    ...
    private function editarArray($post) {
        return array(
            ...
            'precio' => ($post->precio),
            'idtipoproducto' => strtoupper($post->idtipoproducto),
            'estado' => ($post->estado)
        );
    }
