...
class Proveedor extends CI_Controller {
    ...
    public function index() {
        $data = array(
            ...
            'page_header' => 'proveedor',
            'img' => base_url() . 'static/img/empleado.png',
            'list_title' => 'proveedor',
            'nameform' => 'proveedor',
            'titleform' => 'Administración de Proveedores',
    ...
    public function listar() {
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            try {
                $data = array(
                    'data' => $this->Data->listarClienteProveedor(0)
                );
