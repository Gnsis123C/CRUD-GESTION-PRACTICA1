                                ...
                                <div style="border-radius: 0px" class="panel-body">
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12 col-lg-6 col-xl-6">
                                                ...
                                                <div class="input-group">
                                                    <span class="input-group-btn">
                                                        <a href="<?= base_url() ?>proveedor" class="btn btn-primary"><i class="fa fa-plus"></i></a>
                                                    </span>
                                                    <select id="idcliente" class="form-control">
                                                        <option value="">Seleccionar Proveedor</option>
                                                        <?php foreach ($idclienteproveedor as $x): if ($x->tipo == '0') {//clientes ?>
                                            ...
                                            <div class="col-md-12 col-lg-6 col-xl-6">
                                                <input placeholder="Ingresar Fecha" value="<?= $fecha ?>" type="text" id="fecha" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div style="border-radius: 0px" class="panel-body">
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-12 col-lg-2 col-xl-2 form-group">
                                                ...
                                                <select id="idinventario" data-plugin-selectTwo class="form-control">
                                                    ...
                                                    for ($i = 0; $i < count($idproducto); $i++) {
                                                        if ($idproducto[$i]->estado == '1') {
                                                            ?>
                                                            <option valor="1000000" idproducto="<?= $idproducto[$i]->idproducto ?>" cantidad="999999999" restante="999999999" value="<?= $idproducto[$i]->idproducto ?>"><?= $idproducto[$i]->nombre ?></option>
                                                            <?php
                                                        }
                                                    }
                                                    ?>
                                            ...
                                            <div class="col-md-12 col-lg-2 col-xl-2">
                                                <label class="control-label">Fecha de expiraciòn</label>
                                                <input placeholder="Ingresar Fecha" type="text" id="fechaexpi" class="form-control">
                                            </div>
                                    ...
                                    <div class="">
                                        ...
                                        <table class="table table-bordered mb-none">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td style="vertical-align: middle" colspan="6" align="center"><b>Total</b></td>
