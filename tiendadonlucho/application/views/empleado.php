        ...
        <script>
            $(function () {
                ...
                dataTable = $.tablaAjax({
                    ...
                    id: id_text,
                    thead: ['Nombre', 'Apellido', 'Cédula', 'Teléfono', 'Tipo', 'Crear', 'Editar', 'Eliminar', 'Usuario', 'Estado'],
                    ajax: {
                        url: url,
                        urlelim: urlelim,
                        data: {"action": "Jsons"},
                        resp: [
                            {
                                "data": "nombre", "render": function (d, t, f) {
                                    return d.toUpperCase()
                                }
                            },
                            {
                                "data": "apellido", "render": function (d, t, f) {
                                    return d.toUpperCase()
                                }
                            },
                            {
                                "data": "cedula", "render": function (d, t, f) {
                                    return d.toUpperCase()
                                }
                            },
                            {
                                "data": "telefono", "render": function (d, t, f) {
                                    return d.toUpperCase()
                                }
                            },
                            {
                                "data": "tipo", "render": function (d, t, f) {
                                    return d == '1' ? '<label class="label label-success">Administrador</label>' : '<label class="label label-danger">Bodegero</label>';
                                }
                            },
                            {
                                "data": "crear", "render": function (d, t, f) {
                                    return d == '1' ? '<label class="label label-success">activo</label>' : '<label class="label label-danger">inactivo</label>';
                                }
                            },
                            {
                                "data": "editar", "render": function (d, t, f) {
                                    return d == '1' ? '<label class="label label-success">activo</label>' : '<label class="label label-danger">inactivo</label>';
                                }
                            },
                            {
                                "data": "eliminar", "render": function (d, t, f) {
                                    return d == '1' ? '<label class="label label-success">activo</label>' : '<label class="label label-danger">inactivo</label>';
                                }
                            },
                            {
                                "data": "username", "render": function (d, t, f) {
                                    return d.toLowerCase()
                                }
                            },
                            {
                                "data": "estado", "render": function (data, type, full) {
                                    return data == '1' ? '<label class="label label-success">activo</label>' : '<label class="label label-danger">inactivo</label>';
                                },
                                "visible": true
                            }
                        ]
                ...
                var tabla = {
                    ...
                    dir: function (obj) {
                        ...
                        $('#tipo').val(obj[0].tipo);
                        $('#crear').val(obj[0].crear);
                        $('#editar').val(obj[0].editar);
                        $('#eliminar').val(obj[0].eliminar);
                        ...
                        username: {
                            validators: {
                                ...
                                remote: {
                                    ...
                                    url: '<?= base_url() ?>empleado/validaruser',
