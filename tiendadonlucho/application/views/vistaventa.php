    ...
    <body>
        ...
        <script>
            $(function () {
                ...
                var url = '<?= base_url() ?>venta/listar';
                var urlelim = '<?= base_url() ?>venta/eliminar';
                ...
                dataTable = $.tablaAjax({
                    ...
                    id: id_text,
                    thead: ['Nª Factura', 'Cliente', 'Fecha', 'Ir al Detalle'],
                    ajax: {
                        url: url,
                        urlelim: urlelim,
                        data: {"action": "Jsons"},
                        resp: [
                            ...
                            {"data": "fecha"},
                            {
                                "data": "idventa", "render": function (data, type, full) {
                                    return '<a class="btn btn-success btn-xs" href="<?= base_url() ?>venta/detalle?id=' + data + '">Ir al detalle</a>';
                                },
                                "visible": true
                            }
                        ]
