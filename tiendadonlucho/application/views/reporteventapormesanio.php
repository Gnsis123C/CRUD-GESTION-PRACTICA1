                                ...
                                <section class="panel">
                                    <div class="panel-body" id="">
                                        <table class="table table-bordered" id="datatable-tabletools" data-swf-path="assets/vendor/jquery-datatables/extras/TableTools/swf/copy_csv_xls_pdf.swf">
                                            ...
                                            <tr>
                                                <th style="width: 15%;max-width: 15%">N° Venta</th>
                                                <th style="width: 15%;max-width: 15%">Cantidad total</th>
                                                <th style="width: 15%;max-width: 15%">Precio total</th>
                                            ...
                                            <script>
                                                ...
                                                for(var i in datArray){
                                                    chartArray.push({
                                                        "nombre":'V-00' +datArray[i].idventa,
        ...
        <script>
            $(function(){
                $('#anio').change(function(){
                    ...
                    window.location = '<?= base_url() ?>'+'reporte/ventapormesanio?anio='+anio+'&mes='+mes
                });
                $('#mes').change(function(){
                    var mes = $(this).val();
