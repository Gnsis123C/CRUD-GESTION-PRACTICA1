    ...
    <div class="panel-body">
        <form class="form-horizontal" id="demo-form2">
            ...
            <div class="form-group">
                <label for="nomtipo" class="control-label col-md-4 col-sm-3 col-xs-12">Tipo Producto</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <select name="idtipoproducto" id="idtipoproducto" class="form-control" required="">
                        <option value="">Seleccionar tipo</option>
                        <?php
                        foreach ($idtipoproducto as $x) {
                            if ($x->estado == '1') {
                                ?>
                                <option value="<?= $x->idtipoproducto ?>"><?= $x->nombre ?></option>
                                <?php
                            }
                        }
                        ?>
            ...
            <div class="form-group">
                <label for="nomtipo" class="control-label col-md-4 col-sm-3 col-xs-12">Precio</label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input class="touchspin1" required="" placeholder="Ingresar valor" type="text" value="1" name="precio" id="precio">
                </div>
            </div>
