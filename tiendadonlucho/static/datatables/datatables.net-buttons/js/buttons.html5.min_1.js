(function (g) {
            ...
            if (g.isPlainObject(c)) {
                ...
                if (v) {
                    ...
                    for (h = n.length; f < h; f++)
                        k = c.createAttribute(n[f].name.replace(":", "_dt_b_namespace_token_")), k.value = n[f].value, e.setAttributeNode(k)
                }
    ...
    var F = {"_rels/.rels": '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships"><Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/officeDocument" Target="xl/workbook.xml"/></Relationships>',
    ...
    s.ext.buttons.copyHtml5 = {className: "buttons-copy buttons-html5", text: function (a) {
            return a.i18n("buttons.copy", "Copy")
        }, action: function (a, b, d, c) {
            var a = L(b, c), e = a.str, d = g("<div/>").css({height: 1, width: 1, overflow: "hidden", position: "fixed", top: 0, left: 0});
            ...
            if (i.queryCommandSupported("copy")) {
                ...
                try {
                    ...
                    b.buttons.info(b.i18n("buttons.copyTitle",
                            "Copy to clipboard"), b.i18n("buttons.copySuccess", {1: "Copied one row to clipboard", _: "Copied %d rows to clipboard"}, a.rows), 2E3);
                    return
                } catch (f) {
                }
            }
    ...
    s.ext.buttons.csvHtml5 = {className: "buttons-csv buttons-html5", available: function () {
    ...
    s.ext.buttons.excelHtml5 = {className: "buttons-excel buttons-html5", available: function () {
            ...
            var e = 0, a = function (a) {
                ...
                for (var b = 0, c = a.length; b < c; b++) {
                    ...
                    if (typeof a[b] === "number" || a[b].match && g.trim(a[b]).match(/^-?\d+(\.\d+)?$/) && !g.trim(a[b]).match(/^0\d+/))
                        d = o(f, "c", {attr: {t: "n", r: d}, children: [o(f, "v", {text: a[b]})]});
                    else {
                        i = !a[b].replace ? a[b] : a[b].replace(/&(?!amp;)/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/[\x00-\x09\x0B\x0C\x0E-\x1F\x7F-\x9F]/g, "");
                        d = o(f, "c", {attr: {t: "inlineStr", r: d}, children: {row: o(f, "is", {children: {row: o(f, "t", {text: i})}})}})
                    }
                    k.appendChild(d)
                }
                h.appendChild(k);
            ...
            for (l = b.header.length; i < l; i++)
                d.appendChild(o(f, "col", {attr: {min: i + 1, max: i + 1, width: N(b, i), customWidth: 1}}));
    ...
    s.ext.buttons.pdfHtml5 = {className: "buttons-pdf buttons-html5", available: function () {
            ...
            for (var e = 0, d = a.body.length; e < d; e++)
                b.push(g.map(a.body[e], function (a) {
                    return{text: typeof a === "string" ? a : a + "", style: e % 2 ? "tableBodyEven" : "tableBodyOdd",widths: ['*', '*', '*', '*'],alignment: 'justify'}
                }));
            ...
            a = {
                ...
                content: [
                    {table: {widths: ['*', '*', '*', '*'],headerRows: 1, body: b}, layout: "noBorders"}
                ],
                styles:
                        c.styles, 
