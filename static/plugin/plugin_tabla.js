(function ($) {
        ...
        tablaAjax: function (data) {
            ...
            if (tabla.dibujarTabla(data)) {
                dataTable = $('#tabla').DataTable({
                    ...
                    "columnDefs": [
                        {
                            "orderable": false, "className": 'middle select-checkbox', "targets": 1
                        }
                    ],
    ...
    var tabla = {
        ...
        columns: function (data) {
            ...
            listColumn.push({"data": "defaultContent", "render": function () {
                    return '<i class="fa fa-user"></i>';
                }, "orderable": false,className:'middle'});
            listColumn.push({"defaultContent": ''});
            ...
            listColumn.push(
                    {
                        "data": data.id, "render": function (data_, type, full) {
                            ...
                            str += '<li><a href="#" ' + (data.contextMenu.edit.estado == true ? 'rel="action" data-json=\'{"action": "editar","id": "' + data_ + '"}\'' : 'class="dropdown-2-disabled"') + '><i class="fa fa-edit fa-pull-right ' + (data.contextMenu.edit.estado == false ? 'class="dropdown-2-disabled' : '') + ' text-info" style="padding-top:3px"> </i><div style="padding-left: 8px">Editar</div></a></li>'
                            str += '<li><a href="#" ' + (data.contextMenu.elim == true ? ' rel="action" data-json=\'{"action": "eliminar","id": "' + data_ + '"}\'' : 'class="dropdown-2-disabled"') + '><i class="fa fa-trash-o fa-pull-right ' + (data.contextMenu.elim == false ? 'class="dropdown-2-disabled' : '') + ' text-danger" style="padding-top:3px"> </i><i class="fa fa-caret-left"></i> Eliminar</a></li>'
                            str += '</ul>'
                            str += '</div>';
                            str += '';
                            str += '';
        ...
        dibujarTabla: function (data) {
            ...
            html += '<tr>';
            html += '<th>N°</th>';
            html += '<th class="text-center"><input  style="cursor: pointer" title="Marcar todo" type="checkbox" id="marcar_todo"></th>';
            for (var i in thead) {
                var t = thead[i];
                html += '<th>' + t + '</th>';
            }
